            ...
            <div
                ...
                <div class="relative">
                    ...
                    <p class="text-slate-700 text-sm mt-3 leading-relaxed">
                        Daftar untuk mulai mencari informasi travel dengan lebih cepat, rapi, dan praktis.
                    </p>
                </div>
                ...
                <div class="relative">
                    ...
                    <p class="text-slate-700 text-sm mt-3 leading-relaxed">
                        Data kamu diproses dengan aman dan terenkripsi.
                        Kamu juga bisa mendaftar cepat menggunakan Google.
                    </p>
                </div>
                ...
                <div class="relative pt-2">
                    ...
                    <p class="text-slate-600 text-xs mt-4 leading-relaxed">
                        Dengan mendaftar, kamu menyetujui kebijakan dan ketentuan layanan RiauPort.
                    </p>
                </div>
            </div>
                ...
                <form action="{{ route('register.store') }}" method="POST" class="space-y-5">
                    ...
                    <a href="{{ route('google.redirect') }}"
                        class="w-full flex items-center justify-center gap-3 py-3 rounded-2xl
                              border border-gray-300 bg-white hover:bg-gray-50 text-sm font-semibold">
